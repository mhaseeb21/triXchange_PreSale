...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'X (Twitter)', icon: '𝕏', href: 'https://twitter.com/', color: 'hover:text-black dark:hover:text-white' },
    { name: 'Telegram', icon: '✈', href: 'https://t.me/', color: 'hover:text-[#0088cc]' },
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <a href="#disclaimer" className="hover:text-[#bd0404]">Disclaimer</a>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 text-center">
          ...
          <div className="flex max-w-md mx-auto gap-2">
            ...
            />
            <button className="px-6 py-2 bg-[#bd0404] text-white rounded-lg font-semibold hover:bg-[#9a0303]">
              Subscribe
            </button>
          </div>
        </div>
